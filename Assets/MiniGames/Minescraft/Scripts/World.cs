...
public class World : MonoBehaviour
{
    ...
    public static int radius = 2;            // Increase maxCoroutines w/ this
    public static uint maxCoroutines = 1000; // Increase if radius increase
    // Typically increase maxCo from 1000 when radius > 7
    ...
    void BuildChunkAt(int x, int y, int z)
    {
        ...
        if (!chunks.TryGetValue(n, out c))
        {
            ...
            c.fluid.transform.parent = transform;
