...
public class CS_TyrannyTunnel : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        dialogueLines = new string[] {
            "To wit!",
            "I would like to add, as many have already heard, that exhaustion is the point.",
            "They flood us with terrible news, terrible events..",
            ...
            "Look at all the horrific acts, the authoritarian regimes,",
            "the dictators who appeared to be indominable gods..",
            "Until suddenly, they weren't.",
            "I know it's hard.",
            "But I cannot emphasize enough the power of even a single optimist.",
            "Hope is infectious.",
            "The authoritarian seeks to control our perception of reality.",
            ...
            "Encourage action, vigilance, and most importantly, love and community.",
            "It isn't easy. Lord knows..",
            "Sometimes, it takes everything.",
            "But nothing you can do with your life is more noble than to be..",
            "A stalwart defender against despair and hopelessness.",
            "To be the person that, even in the darkest hour, inspires others",
            "to turn on their light, too.",
            "There are more of us than there are of them.",
            "Which is why they put all their energies",
            "into making people seem small, weak, and divide.",
            ...
            "By being someone who inspires hope, by being that rock, that anchor, that beacon..",
            "You give others the strength to keep getting up..",
            "To keep taking action, to keep fighting back.",
            ...
            "They offer us an alternative to the climate of fear and terror around us.",
            "They give us a different path.",
            "They will tell you its pointless.",
            "They will tell you its hopeless.",
            "They will tell you to give up, they will mock you, spit on you,",
            "and everything else to demean and degrade you.",
            "Because they are terrified of that person who does not despair.",
            "Do not allow them to do so.",
            "And you've already taken the greatest step to victory that you can take."
        };
    ...
    void Update()
    {
        ...
        {
            if (!warpTyrannyTunnel.GetComponent<SceneTransitioner>().bAnimationToTransitionScene)
            {
