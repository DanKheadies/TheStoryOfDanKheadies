...
public class CS_ShadowMonster : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        dialogueLines = new string[] {
            ...
            "There's something wrong with that line. It doesn't make sense to me.",
            "Meek doesn't seem to me to be a moral virtue.",
            "Meek is not a good translation. What it means is this...",
            "Those who have swords & know how to use them, but keep them sheathed, will inherit the world.",
            "That's a BIG difference, it's so great. Ya know, cuz everyone says..",
            "You should be harmless, virtuous, you shouldn't do any one any harm.",
            "You should sheath your competitive instinct. You shouldn't try to win.",
            "You don't want to be too aggressive, too assertive. You want to take a backset.",
            "And all of that...",
            "It's like, NO. Wrong.",
            ...
            "So lets say you pick a level of competition where you're always winning.",
            "Well all that means is that you picked the wrong level of competition.",
            "Lets say you're a grand master chess player, and all you do is play amateurs.",
            "And every night you go home and congratulate yourself on what a genius you are.",
            "Because you just stomp these people left, right, and center.",
            "It's like, you're not a genius. You're dim-witted.",
            "What you should be doing is playing people who are",
            "beating you as much as you can tolerate.",
            "You want to be on the edge, where your skills are being developed.",
    ...
    void Update()
    {
        ...
        {
            if (!warpShadowMonster.GetComponent<SceneTransitioner>().bAnimationToTransitionScene)
            {
