...
public class MoveControlsMenuArrow : MonoBehaviour
{
    ...
    void Update()
    {
        if (controlsMenu.localScale == Vector3.one)
        {
            ...
            else if (bControllerDownSecondary)
            {
                bControllerDownSecondary = false;
                controlsMenu.GetChild(0).GetChild(0).localPosition = 
                    new Vector3(
                        controlsMenu.GetChild(0).GetChild(0).localPosition.x,
                        controlsMenu.GetChild(0).GetChild(0).localPosition.y + 50,
                        controlsMenu.GetChild(0).GetChild(0).localPosition.z);
            }
            else if (bControllerUpSecondary)
            {
                bControllerUpSecondary = false;
                controlsMenu.GetChild(0).GetChild(0).localPosition =
                    new Vector3(
                        controlsMenu.GetChild(0).GetChild(0).localPosition.x,
                        controlsMenu.GetChild(0).GetChild(0).localPosition.y - 50,
